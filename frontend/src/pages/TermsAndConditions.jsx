export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto p-6 text-sm md:text-base text-[#5D172E] leading-relaxed">
      <h1 className="text-xl md:text-2xl font-bold uppercase mb-6 tracking-wide">
      ...
      <h2 className="text-base md:text-lg font-bold mt-6 mb-2">
        1. General
      </h2>
      <p>
