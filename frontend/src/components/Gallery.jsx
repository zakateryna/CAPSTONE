...
export default function Gallery({ photos, onSelectPhoto, projectPhoto, onCloseProject }) {
  return (
    <section
      id="gallery-section"
            ...
            <div key={photo.id} className="contents">
              ...
              <button
                ...
                className={[
                  ...
                  isComingSoon ? "opacity-60 cursor-not-allowed" : "cursor-pointer hover:-translate-y-1",
                ].join(" ")}
              >
                <div
